...
(6) 看看内存分配的详细情况, 这个地方看不懂可以看看: [科普文](http://brionas.github.io/2015/01/31/jemalloc源码解析-内存管理/), 关键的是util指标, 指的是内存利用率, 最大的bins内存util是0.661, 说明内存利用率不高
...
![img](redis4支持内存碎片清理功能使用 - hongliuliao的个人空间 - OSCHINA - 中文开源技术交流社区.assets/145729_d4PA_871213.png)
