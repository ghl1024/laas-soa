# Prometheus高可用
 ...
 [来源 郑云龙](https://github.com/yunlzheng/prometheus-book) 浏览 *2283* [ 扫码](https://www.bookstack.cn/read/prometheus-book/ha-prometheus-and-high-availability.md#) [ 分享](https://www.bookstack.cn/read/prometheus-book/ha-prometheus-and-high-availability.md#) *2020-10-11 11:08:41*

- Prometheus高可用部署
  - [基本HA：服务可用性](https://www.bookstack.cn/read/prometheus-book/ha-prometheus-and-high-availability.md#3hm7fv)
  - [基本HA + 远程存储](https://www.bookstack.cn/read/prometheus-book/ha-prometheus-and-high-availability.md#7yookj)
  - [基本HA + 远程存储 + 联邦集群](https://www.bookstack.cn/read/prometheus-book/ha-prometheus-and-high-availability.md#eja1kg)
  - [按照实例进行功能分区](https://www.bookstack.cn/read/prometheus-book/ha-prometheus-and-high-availability.md#6jt9ca)
  - 高可用方案选择
...
![基本HA](https://static.sitestack.cn/projects/prometheus-book/ha/static/promethues-ha-01.png)
...
![HA + Remote Storage](https://static.sitestack.cn/projects/prometheus-book/ha/static/prometheus-ha-remote-storage.png)
...
![基本HA + 远程存储 + 联邦集群](https://static.sitestack.cn/projects/prometheus-book/ha/static/prometheus-ha-rs-fedreation.png)
...
![实例级别功能分区](https://static.sitestack.cn/projects/prometheus-book/ha/static/promethues-sharding-targets.png)
...
上一篇:[联邦集群](https://www.bookstack.cn/read/prometheus-book/ha-scale-prometheus-with-federation.md)

下一篇:[Alertmanager高可用](https://www.bookstack.cn/read/prometheus-book/ha-alertmanager-high-availability.md)