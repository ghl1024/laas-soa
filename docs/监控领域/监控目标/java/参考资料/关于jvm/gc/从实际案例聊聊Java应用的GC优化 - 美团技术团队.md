...
2017年12月29日 作者: 录录 [文章链接](https://tech.meituan.com/2017/12/29/jvm-optimize.html) 8622字 18分钟阅读
...
![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/ab15459b.png)
...
![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/f6e7326e.png)
...
![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/6eb9b856.png)
...
![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/1470cba5.png)
...
调整前：![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/a1532bd7.png)

调整后：![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/ae11fb41.png)
...
![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/ee8d24f9.png)
...
![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/09cf176b.png)

可见，Remark阶段主要是通过扫描堆来判断对象是否存活。那么准确判断对象是否存活，需要扫描哪些对象？CMS对老年代做回收，Remark阶段仅扫描老年代是否可行？结论是不可行，原因如下：![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/eaa94379.png)
...
经过增加CMSScavengeBeforeRemark参数，单次执行时间>200ms的GC停顿消失，从监控上观察，GCtime和业务波动保持一致，不再有明显的毛刺。![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/6b73e4c0.png)
...
![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/df96e180.png)
...
![img](从实际案例聊聊Java应用的GC优化 - 美团技术团队.assets/b15554ea.png)
...
[后台](https://tech.meituan.com/tags/后台.html), [基础研发平台](https://tech.meituan.com/tags/基础研发平台.html), [JVM](https://tech.meituan.com/tags/jvm.html), [性能优化](https://tech.meituan.com/tags/性能优化.html), [GC优化](https://tech.meituan.com/tags/gc优化.html), [技术工程](https://tech.meituan.com/tags/技术工程.html), [Java](https://tech.meituan.com/tags/java.html)