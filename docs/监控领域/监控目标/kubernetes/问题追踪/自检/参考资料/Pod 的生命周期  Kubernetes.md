[Kubernetes 文档](https://kubernetes.io/zh/docs/)[概念](https://kubernetes.io/zh/docs/concepts/)[工作负载](https://kubernetes.io/zh/docs/concepts/workloads/)[Pods](https://kubernetes.io/zh/docs/concepts/workloads/pods/)[Pod 的生命周期](https://kubernetes.io/zh/docs/concepts/workloads/pods/pod-lifecycle/)
...
![img](Pod 的生命周期  Kubernetes.assets/pod.svg)Pod 结构图例
...
- 动手实践[为容器生命周期时间关联处理程序](https://kubernetes.io/zh/docs/tasks/configure-pod-container/attach-handler-lifecycle-event/)。
- 动手实践[配置存活态、就绪态和启动探针](https://kubernetes.io/zh/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/)。
- 进一步了解[容器生命周期回调](https://kubernetes.io/zh/docs/concepts/containers/container-lifecycle-hooks/)。
- 关于 API 中定义的有关 Pod/容器的详细规范信息， 可参阅 [PodStatus](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.20/#podstatus-v1-core) 和 [ContainerStatus](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.20/#containerstatus-v1-core)。