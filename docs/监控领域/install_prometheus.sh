...
wget https://github.com/prometheus/prometheus/releases/download/v2.23.0/prometheus-2.23.0.darwin-amd64.tar.gz
# unpack compress package
tar -zvxf prometheus-2.23.0.linux-amd64.tar.gz
# start prometheus
